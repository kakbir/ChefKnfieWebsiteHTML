                ...
                <div class="woocommerce-page clearfix"> 
                    <div class="col-md-6">                 
                        <div class="flat-product-single-slider">
                            <div id="flat-product-flexslider">
                                <ul class="slides">
                                    <li><img width="570" height="570" alt="product-single" src="images/shop/4.jpg" class="attachment-themesflat-gallery-product size-themesflat-gallery-product"  /></li>
                                     </ul>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="entry-summary">
                            <h2 class="product_title">HATAY DERVİŞ ŞEF BIÇAĞI NO.3</h2>
